...
const VideoBackground = () => (
  <section className="relative h-screen flex items-center justify-center">
    ...
    <div className="text-white text-center z-10">
      <h1 className="text-6xl md:text-8xl font-bold mb-4">Explore the Learniverse</h1>
      <h1 className="text-3xl md:text-3xl font-bold mb-4">a universe where you can learn and discover new adventures</h1>
